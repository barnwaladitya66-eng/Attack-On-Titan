...
const AOT_DATA = {
  ...
  // MULTIMEDIA FAN EXPERIENCE HUB DATA
  multimediaHub: {
    soundtracks: [
      {
        id: "vogel-im-kafig",
        title: "Vogel im Käfig (Bird in a Cage)",
        composer: "Hiroyuki Sawano",
        vocalist: "Cyua",
        album: "Attack on Titan OST (Season 1)",
        duration: "6:20",
        mood: "Tragic / Climactic Melodrama",
        description: "The emotional epic accompanying Carla Yeager's sacrifice, the fall of Shiganshina, and Eren's desperate vows.",
        audioFrequency: "432 Hz Cinematic Orchestral"
      },
      {
        id: "youseebiggirl",
        ...
        composer: "Hiroyuki Sawano",
        vocalist: "Gemie",
        album: "Attack on Titan Season 2 OST",
        duration: "5:58",
        mood: "Heart-Wrenching Betrayal / Epic Choral",
        description: "Plays during Reiner and Bertholdt's shocking revelation on the top of Wall Rose in Season 2 Episode 6.",
        audioFrequency: "528 Hz Choral Requiem"
      },
      {
        id: "the-rumbling",
        title: "The Rumbling",
        composer: "SiM (Silence iz Mine)",
        vocalist: "MAH",
        album: "Attack on Titan: The Final Season Part 2 OP",
        duration: "3:40",
        mood: "Heavy Metal / Apocalyptic Fury",
        description: "The ferocious metal anthem capturing Eren Yeager's irreversible decision to trample the global world.",
        audioFrequency: "Drop-C Heavy Core"
      },
      {
        id: "guren-no-yumiya",
        title: "Guren no Yumiya (紅蓮の弓矢)",
        composer: "Revo (Linked Horizon)",
        vocalist: "Revo",
        album: "Attack on Titan Season 1 OP 1",
        duration: "5:16",
        mood: "Triumphant March / Battle Anthem",
        description: "The legendary anthem of humanity's counterattack: 'Seid ihr das Essen? Nein, wir sind der Jäger!'",
        audioFrequency: "Symphonic Power Metal"
      },
      {
        id: "barricades",
        title: "Barricades",
        ...
        album: "Attack on Titan Season 2 OST",
        duration: "3:41",
        mood: "High-Energy ODM Combat",
        description: "The pulse-pounding electronic rock track underscoring the Survey Corps' desperate rescue operations.",
        audioFrequency: "High-BPM Electronic Rock"
      },
      {
        id: "call-of-silence",
        ...
        album: "Attack on Titan Season 2 OST",
        duration: "2:57",
        mood: "Ethereal / Rebirth of Ymir",
        description: "The haunting, beautiful lullaby accompanying Ymir's past in Marley and her rebirth in the vast sandy desert.",
        audioFrequency: "Celestial Ambient Piano"
      }
    ],
    ...
    wallpapers: [
      {
        id: "art-shiganshina",
        title: "The Grim Reminder • Wall Maria Breach",
        category: "Battles",
        resolution: "3840 × 2160 (4K UHD)",
        tag: "Shiganshina Year 845",
        desc: "The 60-meter Colossal Titan looms above the outer district wall, enveloped in crimson steam."
      },
      {
        id: "art-paths",
        title: "The Coordinate Nexus • The Paths Tree",
        category: "Lore",
        resolution: "3840 × 2160 (4K UHD)",
        tag: "Metaphysical Dimension",
        desc: "A luminous celestial tree branching across eternal night where all Eldian souls connect across time."
      },
      {
        id: "art-levi-forest",
        title: "Thunder in the Giant Trees • Levi vs Beast",
        category: "Characters",
        resolution: "2560 × 1440 (2K QHD)",
        tag: "Survey Corps Vanguard",
        desc: "Captain Levi slicing at terminal velocity through high-tension steel wires amid giant sequoias."
      },
      {
        id: "art-rumbling-march",
        title: "Doomsday Awakening • The Rumbling",
        category: "Titans",
        resolution: "3840 × 2160 (4K UHD)",
        tag: "Final Season Climax",
        desc: "Millions of crystallized Colossal Titans unhardened, striding across boiling oceans in synchronized apocalypse."
      },
      {
        id: "art-three-walls",
        title: "The Concentric Sanctuary • Maria, Rose, Sina",
        category: "World",
        resolution: "3840 × 2160 (4K UHD)",
        tag: "Paradis Island Geography",
        desc: "Tactical cartographic illustration depicting the three rings of stone enclosing humanity."
      },
      {
        id: "art-fort-salta",
        title: "The Battle of Heaven and Earth",
        category: "Battles",
        resolution: "3840 × 2160 (4K UHD)",
        tag: "Fort Salta Year 854",
        desc: "The Allied Coalition fighting upon the colossal skeletal spine of the Doomsday Titan."
      }
    ]
  },

  // EXPANDABLE TIMELINE MEDIA DRAWERS & DECLASSIFIED MEMORIES
  timelineMediaDrawers: {
    "ancient-history": {
      mediaType: "Origin Revelation",
      tacticalDiagram: "Metaphysical organic anomaly bonding in prehistoric forest tree basin.",
      declassifiedDialogue: "「お前は奴隷ではない。神でもない。ただの人だ。選ぶのはお前だ」\n'You are not a slave. You are not a god. You're just a human being. You decide.' — Eren to Ymir",
      keyCasualties: "Countless ancient Marleyan armies; sacrifice of Ymir Fritz by assassin's spear.",
      intelTags: ["Organic Anomaly", "Ymir Fritz", "Split into Nine Titans"]
    },
    "great-titan-war": {
      mediaType: "Imperial Collapse",
      tacticalDiagram: "Paradis evacuation fleet routes across the ocean; crystallization of Wall Titans.",
      declassifiedDialogue: "「我がエルディア帝国はあまりにも多くの命を奪ってきた…」\n'Our Eldian Empire has taken far too many lives...' — King Karl Fritz",
      keyCasualties: "Millions displaced; total destruction of continental Eldian royal capital.",
      intelTags: ["Karl Fritz", "Tybur Conspiracy", "Memory Erasure"]
    },
    "fall-of-shiganshina": {
      mediaType: "Breach Telemetry",
      tacticalDiagram: "Outer gate pulverized by Colossal steam kick; inner gate breached by Armored charge.",
      declassifiedDialogue: "「駆逐してやる…この世から…一匹残らず！」\n'I will exterminate them... from this world... every last one!' — Young Eren Yeager",
      keyCasualties: "Carla Yeager; 10,000+ civilians in Shiganshina; 250,000 in reclamation campaign.",
      intelTags: ["Colossal Breach", "Armored Charge", "Grisha's Injection"]
    },
    "trost-and-female-titan": {
      mediaType: "Tactical Reclamation",
      tacticalDiagram: "Survey Corps boulder escort formation in Trost District; Forest of Giant Trees trap.",
      declassifiedDialogue: "「死んだらもう…あなたのことを思い出すことすらできない」\n'If I die... I won't even be able to remember you.' — Mikasa Ackerman",
      keyCasualties: "Special Operations Squad (Gunther, Eld, Oluo, Petra); Trost Garrison 1st Division.",
      intelTags: ["Boulder Sealing", "Female Titan Ambush", "Stohess Capture"]
    },
    "uprising-and-shiganshina": {
      mediaType: "Classified Truth",
      tacticalDiagram: "Erwin suicide cavalry charge line; Armin steam distraction; Basement key lock.",
      declassifiedDialogue: "「我が兵士よ怒れ！我が兵士よ叫べ！我が兵士よ戦え！！」\n'My soldiers, rage! My soldiers, scream! My soldiers, fight!!' — Commander Erwin Smith",
      keyCasualties: "Commander Erwin Smith; 199 Survey Corps soldiers; Bertholdt Hoover devoured.",
      intelTags: ["Erwin's Charge", "Basement Photograph", "Serum Choice"]
    },
    "marley-and-war-for-paradis": {
      mediaType: "Infiltration Record",
      tacticalDiagram: "Liberio festival stage subterranean acoustic infiltration; Zeppelin extraction vector.",
      declassifiedDialogue: "「ライナー…座れよ」\n'Reiner... sit down.' — Eren Yeager in Liberio Basement",
      keyCasualties: "Willy Tybur; Lara Tybur; Sasha Braus; Marley Naval High Command.",
      intelTags: ["Declaration of War", "War Hammer Devoured", "Yeagerist Coup"]
    },
    "the-rumbling": {
      mediaType: "Cataclysmic March",
      tacticalDiagram: "Global trampling wavefront radiating across 80% continental landmass; Fort Salta drop.",
      declassifiedDialogue: "「いってらっしゃい、エレン」\n'See you later, Eren.' — Mikasa Ackerman",
      keyCasualties: "80% of global humanity; Eren Yeager; Hange Zoë; Zeke Yeager.",
      intelTags: ["80% Trampled", "Curse of Ymir Ended", "Battle of Heaven & Earth"]
    }
  }
};
