...
function initBasementVault() {
  const BASEMENT_QUESTION_POOL = [
    ...
    {"id": 21, "question": "What is the true identity of the Beast Titan shifter?", "options": ["Zeke Yeager", "Tom Ksaver", "Colt Grice", "Bertholdt Hoover"], "correctAnswer": "Zeke Yeager", "answer": "Zeke Yeager"},
    {"id": 22, "question": "Which weapon was specially developed by Marley to combat the Scout Regiment's ODM gear?", "options": ["Anti-Personnel ODM Gear", "Thunder Spears", "Cart Titan Artillery", "Panzer Unit Guns"], "correctAnswer": "Anti-Personnel ODM Gear", "answer": "Anti-Personnel ODM Gear"},
    {"id": 23, "question": "What is the name of the military faction led by Floch Forster that supports Eren?", "options": ["Jaegerists", "Garrison Regiment", "Military Police", "Restorationists"], "correctAnswer": "Jaegerists", "answer": "Jaegerists"},
    {"id": 24, "question": "Which Titan shifter was eaten by Ymir outside Wall Maria before she joined the 104th Training Corps?", "options": ["Marcel Galliard", "Porco Galliard", "Bertholdt Hoover", "Pieck Finger"], "correctAnswer": "Marcel Galliard", "answer": "Marcel Galliard"},
    {"id": 25, "question": "What alloy is used to forge the durable blades used by the Scout Regiment?", "options": ["Ultrahard Steel", "Iceburst Steel", "Iron Bamboo", "Titan Crystal"], "correctAnswer": "Ultrahard Steel", "answer": "Ultrahard Steel"},
    {"id": 26, "question": "Who was the commander of the Garrison Regiment responsible for the defense of the southern territory?", "options": ["Dot Pyxis", "Nile Dawk", "Keith Shadis", "Kitz Weilman"], "correctAnswer": "Dot Pyxis", "answer": "Dot Pyxis"},
    {"id": 27, "question": "What was the name of Kenny Ackerman's squad within the Military Police?", "options": ["Anti-Personnel Control Squad", "First Interior Squad", "Scout Enforcement Unit", "Capital Guard"], "correctAnswer": "Anti-Personnel Control Squad", "answer": "Anti-Personnel Control Squad"},
    {"id": 28, "question": "Which Eldian city district was breaches during the second Colossal Titan attack five years after Shiganshina?", "options": ["Trost District", "Krolva District", "Stohess District", "Ermich District"], "correctAnswer": "Trost District", "answer": "Trost District"},
    {"id": 29, "question": "What animal form did Tom Ksaver's Beast Titan resemble?", "options": ["Ram", "Ape", "Horse", "Falcon"], "correctAnswer": "Ram", "answer": "Ram"},
    {"id": 30, "question": "Who was the head of the Tybur family that announced the war against Paradis Island in Liberio?", "options": ["Willy Tybur", "Lara Tybur", "Fine Tybur", "Bruno Tybur"], "correctAnswer": "Willy Tybur", "answer": "Willy Tybur"},
    {"id": 31, "question": "What is the secret weakness located on the body of every Pure and Intelligent Titan?", "options": ["The Nape", "The Heart", "The Spine Base", "The Forehead"], "correctAnswer": "The Nape", "answer": "The Nape"},
    {"id": 32, "question": "Which Scout Regiment squad leader was famous for extreme obsession with Titan research?", "options": ["Hange Zoë", "Miche Zacharius", "Moblit Berner", "Nifa"], "correctAnswer": "Hange Zoë", "answer": "Hange Zoë"},
    {"id": 33, "question": "What weapon was invented by the Scouts specifically to breach the Armor Titan's hardened skin?", "options": ["Thunder Spears", "Signal Flares", "Scout Sabers", "Artillery Shells"], "correctAnswer": "Thunder Spears", "answer": "Thunder Spears"},
    {"id": 34, "question": "What is the name of the Marleyan warrior candidate who inherited the Armored Titan's memory vision?", "options": ["Falco Grice", "Gabi Braun", "Udo", "Zofia"], "correctAnswer": "Falco Grice", "answer": "Falco Grice"},
    {"id": 35, "question": "Which Ackerman was known as 'Kenny the Ripper' in the Underground City?", "options": ["Kenny Ackerman", "Levi Ackerman", "Mikasa Ackerman", "Kuchel Ackerman"], "correctAnswer": "Kenny Ackerman", "answer": "Kenny Ackerman"},
    {"id": 36, "question": "What is the name of the dimension where all Subjects of Ymir are connected through coordinate paths?", "options": ["The Paths", "The Void", "The Abyss", "The Realm"], "correctAnswer": "The Paths", "answer": "The Paths"},
    {"id": 37, "question": "Which Titan possesses quadrupedal mobility and can carry heavy artillery equipment for months?", "options": ["Cart Titan", "Jaw Titan", "Beast Titan", "Founding Titan"], "correctAnswer": "Cart Titan", "answer": "Cart Titan"},
    {"id": 38, "question": "What was the occupation of Carla Yeager before marrying Grisha Yeager?", "options": ["Waitress", "Nurse", "Seamstress", "Merchant"], "correctAnswer": "Waitress", "answer": "Waitress"},
    {"id": 39, "question": "Who was the ruler of Paradis Island who wiped the memories of the citizens inside the Walls?", "options": ["Karl Fritz", "Rod Reiss", "Uri Reiss", "Frieda Reiss"], "correctAnswer": "Karl Fritz", "answer": "Karl Fritz"},
    {"id": 40, "question": "What is the ultimate event triggered when the Founding Titan unhardens the Wall Titans?", "options": ["The Rumbling", "The Great Cleansing", "The Earth Scourge", "The Titan Awakening"], "correctAnswer": "The Rumbling", "answer": "The Rumbling"}
  ];
